  ...
  */
  ...
  export interface UserDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * const userWithMetadataOnly = await prisma.user.findMany({ select: { metadata: true } })
     * 
    **/
  ...
  export interface ProfileDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `metadata`
     * const profileWithMetadataOnly = await prisma.profile.findMany({ select: { metadata: true } })
     * 
    **/
